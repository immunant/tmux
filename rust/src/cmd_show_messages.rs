...
pub const JOB_CLOSED: unnamed_12 = 2;
...
pub const JOB_RUNNING: unnamed_12 = 0;
#[derive ( Copy , Clone )]
#[repr ( C )]
...
pub const JOB_DEAD: unnamed_12 = 1;
#[derive ( Copy , Clone )]
#[repr ( C )]
...
unsafe extern "C" fn cmd_show_messages_exec(mut self_0: *mut cmd,
 ...
 -> cmd_retval {
    ...
    if c == 0 as *mut libc::c_void as *mut client {
        ...
        if 0 != args_has(args, 84 as u_char) {
            blank = cmd_show_messages_terminals(item, blank);
            done = 1i32
        }
        if 0 != args_has(args, 74 as u_char) {
        ...
        if 0 != done {
            ...
            msg = (*(&mut (*c).message_log as *mut unnamed_18)).tqh_first;
            while msg != 0 as *mut libc::c_void as *mut message_entry {
                tim = ctime(&mut (*msg).msg_time as *mut time_t);
                *strchr(tim, 10) = 0 as libc::c_char;
                cmdq_print(item,
...
unsafe extern "C" fn cmd_show_messages_jobs(mut item: *mut cmdq_item,
 ...
 -> libc::c_int {
    ...
    return (n != 0i32 as libc::c_uint) as libc::c_int;
}
unsafe extern "C" fn cmd_show_messages_terminals(mut item: *mut cmdq_item,
                                                 mut blank: libc::c_int)
 -> libc::c_int {
    ...
    while term != 0 as *mut libc::c_void as *mut tty_term {
        if 0 != blank {
            cmdq_print(item, b"%s\x00" as *const u8 as *const libc::c_char,
                       b"\x00" as *const u8 as *const libc::c_char);
            blank = 0i32
        ...
        cmdq_print(item,
                   b"Terminal %u: %s [references=%u, flags=0x%x]:\x00" as
                       *const u8 as *const libc::c_char, n, (*term).name,
