...
use cmd::{cmd, unnamed_36 as unnamed_24, cmd_entry, cmd_entry_flag};
...
extern "C" {
    ...
    #[no_mangle]
    fn key_bindings_add(_: *const libc::c_char, _: key_code, _: libc::c_int,
                        _: *mut cmd_list) -> ();
    #[no_mangle]
...
unsafe extern "C" fn cmd_bind_key_exec(mut self_0: *mut cmd,
 ...
 -> cmd_retval {
    ...
    if key == 281470681743360u64 || key == 281466386776064u64 {
        ...
        cmdlist =
            cmd_list_parse((*args).argc - 1i32, (*args).argv.offset(1isize),
                           0 as *const libc::c_char, 0i32 as u_int,
        ...
        if cmdlist == 0 as *mut libc::c_void as *mut cmd_list {
            ...
            key_bindings_add(tablename, key, args_has(args, 114 as u_char),
                             cmdlist);
...
pub static mut cmd_bind_key_entry: cmd_entry =
    unsafe {
        cmd_entry{name: b"bind-key\x00" as *const u8 as *const libc::c_char,
