...
pub struct sigaction {
    pub __sigaction_handler: unnamed_15,
...
pub const JOB_DEAD: unnamed_50 = 1;
#[derive ( Copy , Clone )]
#[repr ( C )]
...
pub const JOB_RUNNING: unnamed_50 = 0;
#[derive ( Copy , Clone )]
#[repr ( C )]
pub struct session {
    pub id: u_int,
...
pub const JOB_CLOSED: unnamed_50 = 2;
#[derive ( Copy , Clone )]
#[repr ( C )]
...
pub type unnamed_50 = libc::c_uint;
...
pub unsafe extern "C" fn proc_set_signals(mut tp: *mut tmuxproc,
    ...
    let mut sa: sigaction =
        sigaction{__sigaction_handler: unnamed_15{sa_handler: None,},
