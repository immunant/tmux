...
pub static mut cmd_lock_session_entry: cmd_entry =
    unsafe {
        cmd_entry{name:
                      b"lock-session\x00" as *const u8 as *const libc::c_char,
...
pub static mut cmd_lock_server_entry: cmd_entry =
    unsafe {
        cmd_entry{name:
                      b"lock-server\x00" as *const u8 as *const libc::c_char,
...
pub static mut cmd_lock_client_entry: cmd_entry =
    unsafe {
        cmd_entry{name:
                      b"lock-client\x00" as *const u8 as *const libc::c_char,
