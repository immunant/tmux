...
#[no_mangle]
pub unsafe extern "C" fn environ_RB_REMOVE(mut head: *mut environ,
 ...
 -> *mut environ_entry {
    ...
    if (*elm).entry.rbe_left == 0 as *mut libc::c_void as *mut environ_entry {
        ...
        } else { current_block = 4440632839760836095; }
    }
    match current_block {
        9386390421034826751 => {
            parent = (*elm).entry.rbe_parent;
...
#[no_mangle]
pub unsafe extern "C" fn environ_RB_REMOVE_COLOR(mut head: *mut environ,
                                                 mut parent:
                                                     *mut environ_entry,
                                                 mut elm: *mut environ_entry)
 -> () {
...
#[no_mangle]
pub unsafe extern "C" fn environ_RB_NEXT(mut elm: *mut environ_entry)
 -> *mut environ_entry {
...
#[no_mangle]
pub unsafe extern "C" fn environ_RB_MINMAX(mut head: *mut environ,
                                           mut val: libc::c_int)
 -> *mut environ_entry {
...
#[no_mangle]
pub unsafe extern "C" fn environ_RB_INSERT(mut head: *mut environ,
                                           mut elm: *mut environ_entry)
 -> *mut environ_entry {
    let mut tmp: *mut environ_entry = 0 as *mut environ_entry;
    let mut parent: *mut environ_entry = 0 as *mut environ_entry;
...
#[no_mangle]
pub unsafe extern "C" fn environ_RB_INSERT_COLOR(mut head: *mut environ,
                                                 mut elm: *mut environ_entry)
 -> () {
    let mut current_block: u64;
    let mut parent: *mut environ_entry = 0 as *mut environ_entry;
 ...
 -> *mut environ_entry {
    let mut envent: environ_entry =
        environ_entry{name: 0 as *mut libc::c_char,
                      ...
                      entry:
                          unnamed_29{rbe_left: 0 as *mut environ_entry,
...
#[no_mangle]
pub unsafe extern "C" fn environ_RB_FIND(mut head: *mut environ,
                                         mut elm: *mut environ_entry)
 -> *mut environ_entry {
    let mut tmp: *mut environ_entry = (*head).rbh_root;
...
#[no_mangle]
pub unsafe extern "C" fn environ_RB_NFIND(mut head: *mut environ,
                                          mut elm: *mut environ_entry)
 -> *mut environ_entry {
    let mut tmp: *mut environ_entry = (*head).rbh_root;
...
#[no_mangle]
pub unsafe extern "C" fn environ_RB_PREV(mut elm: *mut environ_entry)
 -> *mut environ_entry {
