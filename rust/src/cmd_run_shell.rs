...
pub const TTY_VT100: unnamed_17 = 0;
...
pub const TTY_UNKNOWN: unnamed_17 = 6;
...
pub const TTY_VT220: unnamed_17 = 3;
#[derive ( Copy , Clone )]
#[repr ( C )]
...
pub const TTY_VT420: unnamed_17 = 5;
...
pub const TTY_VT320: unnamed_17 = 4;
pub const TTY_VT102: unnamed_17 = 2;
...
pub const TTY_VT101: unnamed_17 = 1;
...
unsafe extern "C" fn cmd_run_shell_callback(mut job: *mut job) -> () {
    ...
    if (unnamed_21{__in: (*job).status,}.__i & 127i32 == 0i32) {
        retcode = (unnamed_25{__in: (*job).status,}.__i & 65280i32) >> 8i32;
        if retcode != 0i32 {
            xasprintf(&mut msg as *mut *mut libc::c_char,
                      b"\'%s\' returned %d\x00" as *const u8 as
                          *const libc::c_char, cmd, retcode);
        }
    } else if (((unnamed_27{__in: (*job).status,}.__i & 127i32) + 1i32) as
                   libc::c_schar as libc::c_int >> 1i32 > 0i32) {
        retcode = unnamed_38{__in: (*job).status,}.__i & 127i32;
        xasprintf(&mut msg as *mut *mut libc::c_char,
