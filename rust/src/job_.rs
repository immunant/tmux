...
pub const SHUT_WR: unnamed_23 = 1;
...
pub const SHUT_RDWR: unnamed_23 = 2;
#[derive ( Copy , Clone )]
#[repr ( C )]
...
pub const SHUT_RD: unnamed_23 = 0;
#[derive ( Copy , Clone )]
#[repr ( C )]
...
pub static mut all_jobs: joblist =
    unsafe { joblist{lh_first: 0 as *const job as *mut job,} };
#[no_mangle]
