...
extern "C" {
    ...
    #[no_mangle]
    fn evbuffer_add_buffer(outbuf: *mut evbuffer, inbuf: *mut evbuffer)
     -> libc::c_int;
    #[no_mangle]
    ...
    #[no_mangle]
    fn control_write(_: *mut client, _: *const libc::c_char, ...) -> ();
    #[no_mangle]
...
#[no_mangle]
pub unsafe extern "C" fn control_callback(mut c: *mut client,
    ...
    if 0 != closed { (*c).flags |= 4i32 }
    loop  {
        line =
            evbuffer_readln((*c).stdin_data, 0 as *mut size_t,
                            EVBUFFER_EOL_LF);
        ...
        if *line as libc::c_int == 0 {
            ...
            cmdlist =
                cmd_string_parse(line, 0 as *const libc::c_char,
                                 0i32 as u_int,
                                 &mut cause as *mut *mut libc::c_char);
            if cmdlist == 0 as *mut libc::c_void as *mut cmd_list {
                item =
                    cmdq_get_callback1(b"control_error\x00" as *const u8 as
                                           *const libc::c_char,
                                       Some(control_error),
                                       cause as *mut libc::c_void);
                cmdq_append(c, item);
            } else {
                cmd = (*(&mut (*cmdlist).list as *mut unnamed_35)).tqh_first;
...
#[no_mangle]
pub unsafe extern "C" fn control_write_buffer(mut c: *mut client,
