...
pub const PROMPT_ENTRY: unnamed_20 = 0;
#[derive ( Copy , Clone )]
#[repr ( C )]
pub struct client {
...
pub type bufferevent_event_cb =
    Option<unsafe extern "C" fn(_: *mut bufferevent, _: libc::c_short,
                                _: *mut libc::c_void) -> ()>;
pub const TTY_VT420: unnamed_4 = 5;
#[derive ( Copy , Clone )]
#[repr ( C )]
pub struct winlinks {
...
pub const TTY_UNKNOWN: unnamed_4 = 6;
...
pub const TTY_VT101: unnamed_4 = 1;
#[derive ( Copy , Clone )]
#[repr ( C )]
pub struct window {
    pub id: u_int,
...
pub type bufferevent_data_cb =
    Option<unsafe extern "C" fn(_: *mut bufferevent, _: *mut libc::c_void)
               -> ()>;
pub const TTY_VT220: unnamed_4 = 3;
...
pub const TTY_VT102: unnamed_4 = 2;
#[derive ( Copy , Clone )]
#[repr ( C )]
...
pub const PROMPT_COMMAND: unnamed_20 = 1;
pub type cmdq_cb =
    Option<unsafe extern "C" fn(_: *mut cmdq_item, _: *mut libc::c_void)
               -> cmd_retval>;
pub const TTY_VT100: unnamed_4 = 0;
#[derive ( Copy , Clone )]
#[repr ( C )]
...
pub const TTY_VT320: unnamed_4 = 4;
...
static mut grid_default_entry: grid_cell_entry =
    unsafe {
        grid_cell_entry{flags: 0i32 as u_char,
                        unnamed:
                            unnamed_12{data:
                                           unnamed_35{attr: 0i32 as u_char,
                                                      fg: 8i32 as u_char,
                                                      bg: 8i32 as u_char,
                                                      data: 32 as u_char,},},}
    };
 ...
 -> *mut libc::c_char {
    ...
    loop  {
        match current_block {
            ...
            _ => { *buf.offset(off as isize) = 0 as libc::c_char; return buf }
        }
    };
}
unsafe extern "C" fn grid_string_cells_code(mut lastgc: *const grid_cell,
 ...
 -> () {
    ...
    let mut attrs: [unnamed_22; 8] =
        [unnamed_22{mask: 1i32 as u_int, code: 1i32 as u_int,},
         unnamed_22{mask: 2i32 as u_int, code: 2i32 as u_int,},
         unnamed_22{mask: 64i32 as u_int, code: 3i32 as u_int,},
         unnamed_22{mask: 4i32 as u_int, code: 4i32 as u_int,},
         unnamed_22{mask: 8i32 as u_int, code: 5i32 as u_int,},
         unnamed_22{mask: 16i32 as u_int, code: 7i32 as u_int,},
         unnamed_22{mask: 32i32 as u_int, code: 8i32 as u_int,},
         unnamed_22{mask: 256i32 as u_int, code: 9i32 as u_int,}];
    n = 0i32 as size_t;
    i = 0i32 as size_t;
    while i <
              (::std::mem::size_of::<[unnamed_22; 8]>() as
                   libc::c_ulong).wrapping_div(::std::mem::size_of::<unnamed_22>()
                                                   as libc::c_ulong) {
 ...
 -> size_t {
    ...
    if 0 != (*gc).bg & 16777216i32 {
        ...
        *values.offset(fresh13 as isize) = b as libc::c_int
        ...
        match (*gc).bg {
            0 | 1 | 2 | 3 | 4 | 5 | 6 | 7 => {
                current_block = 1579310001234171462;
                match current_block {
            ...
            8 => {
                current_block = 1885083574712514849;
                match current_block {
                    17707972700779680636 => {
                        let fresh16 = n;
                        n = n.wrapping_add(1);
 ...
 -> size_t {
    ...
    if 0 != (*gc).fg & 16777216i32 {
        ...
        *values.offset(fresh24 as isize) = b as libc::c_int
        ...
        match (*gc).fg {
            0 | 1 | 2 | 3 | 4 | 5 | 6 | 7 => {
                current_block = 16229463110989165485;
                match current_block {
                    16229463110989165485 => {
                        let fresh25 = n;
                        n = n.wrapping_add(1);
                        *values.offset(fresh25 as isize) = (*gc).fg + 30i32
                    }
                    10423576959047460002 => {
                        let fresh26 = n;
                        n = n.wrapping_add(1);
            ...
            8 => {
                current_block = 10423576959047460002;
                match current_block {
                    16229463110989165485 => {
                        let fresh25 = n;
                        n = n.wrapping_add(1);
            ...
            90 | 91 | 92 | 93 | 94 | 95 | 96 | 97 => {
                current_block = 13959387805038036081;
                match current_block {
                    16229463110989165485 => {
                        let fresh25 = n;
                        n = n.wrapping_add(1);
