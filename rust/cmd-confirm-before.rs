...
unsafe extern "C" fn cmd_confirm_before_exec(mut self_0: *mut cmd,
 ...
 -> cmd_retval {
    ...
    if c == 0 as *mut libc::c_void as *mut client {
        ...
        prompt = args_get(args, 112 as u_char);
        if prompt != 0 as *mut libc::c_void as *const libc::c_char {
        ...
        status_prompt_set(c, new_prompt, 0 as *const libc::c_char,
                          Some(cmd_confirm_before_callback),
                          Some(cmd_confirm_before_free),
                          cdata as *mut libc::c_void, 1i32);
...
unsafe extern "C" fn cmd_confirm_before_callback(mut c: *mut client,
 ...
 -> libc::c_int {
    ...
    if 0 != (*c).flags & 512i32 {
        return 0i32
    } else if s == 0 as *mut libc::c_void as *const libc::c_char ||
                  *s as libc::c_int == 0 {
        return 0i32
        ...
        cmdlist =
            cmd_string_parse((*cdata).cmd, 0 as *const libc::c_char,
                             0i32 as u_int,
        ...
        if cmdlist == 0 as *mut libc::c_void as *mut cmd_list {
            if cause != 0 as *mut libc::c_void as *mut libc::c_char {
                new_item =
                    cmdq_get_callback1(b"cmd_confirm_before_error\x00" as
                                           *const u8 as *const libc::c_char,
                                       Some(cmd_confirm_before_error),
...
unsafe extern "C" fn cmd_confirm_before_error(mut item: *mut cmdq_item,
                                              mut data: *mut libc::c_void)
 -> cmd_retval {
