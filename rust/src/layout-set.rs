 ...
 -> libc::c_int {
    ...
    loop  {
        if (i as libc::c_ulong) <
               (::std::mem::size_of::<[unnamed_16; 5]>() as
                    libc::c_ulong).wrapping_div(::std::mem::size_of::<unnamed_16>()
                                                    as libc::c_ulong) {
...
static mut layout_sets: [unnamed_16; 5] =
    unsafe {
        [unnamed_16{name:
         ...
         unnamed_16{name: b"tiled\x00" as *const u8 as *const libc::c_char,
