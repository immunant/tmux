        ...
        match ch {
            39 => {
                ...
                if t == 0 as *mut libc::c_void as *mut libc::c_char {
                    current_block = 9168703867434567782;
                    break ;
                }
            ...
            -1 | 32 | 9 => { current_block = 13859042411183768487; }
            126 => {
...
unsafe extern "C" fn cmd_string_variable(mut s: *const libc::c_char,
 ...
 -> *mut libc::c_char {
    ...
    match ch {
        -1 => { current_block = 16634541453733830859; }
        123 => {
            fch = 123;
            ch = cmd_string_getc(s, p);
            if !(ch == 95 || ch >= 97 && ch <= 122 || ch >= 65 && ch <= 90) {
                current_block = 16634541453733830859;
            } else { current_block = 16227122863032523905; }
        }
        _ => { current_block = 16227122863032523905; }
    }
    match current_block {
        16227122863032523905 => {
            if !(ch == 95 || ch >= 97 && ch <= 122 || ch >= 65 && ch <= 90) {
                    ...
                    if !(0 == esc) {
                        ...
                        match ch {
                            ...
                            101 => {
                                ...
                                match current_block {
                                    11452846818681027168 => { ch = 27 }
                                    3996196671532516695 => { ch = 13 }
                                    6313281317753268 => { ch = 9 }
                                    _ => { ch = 10 }
                                }
                            }
                            114 => {
                            ...
                            110 => {
                                current_block = 1853122534721642507;
                                match current_block {
                                    11452846818681027168 => { ch = 27 }
                                    3996196671532516695 => { ch = 13 }
                                    6313281317753268 => { ch = 9 }
                            ...
                            116 => {
                                current_block = 6313281317753268;
                                match current_block {
                                    11452846818681027168 => { ch = 27 }
                                    3996196671532516695 => { ch = 13 }
                                    6313281317753268 => { ch = 9 }
