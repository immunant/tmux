...
pub const TTY_VT220: unnamed_39 = 3;
...
pub const TTY_VT101: unnamed_39 = 1;
...
pub const JOB_DEAD: unnamed_32 = 1;
#[derive ( Copy , Clone )]
#[repr ( C )]
...
pub const TTY_VT100: unnamed_39 = 0;
...
pub const JOB_RUNNING: unnamed_32 = 0;
...
pub const TTY_VT102: unnamed_39 = 2;
#[derive ( Copy , Clone )]
#[repr ( C )]
...
pub const TTY_VT420: unnamed_39 = 5;
#[derive ( Copy , Clone )]
#[repr ( C )]
...
pub const TTY_UNKNOWN: unnamed_39 = 6;
...
pub const TTY_VT320: unnamed_39 = 4;
...
pub const JOB_CLOSED: unnamed_32 = 2;
#[derive ( Copy , Clone )]
#[repr ( C )]
...
unsafe extern "C" fn cmd_respawn_window_exec(mut self_0: *mut cmd,
 ...
 -> cmd_retval {
    ...
    if 0 == args_has((*self_0).args, 107 as u_char) {
        ...
        while wp != 0 as *mut libc::c_void as *mut window_pane {
            if (*wp).fd == 1i32.wrapping_neg() {
                ...
                cmdq_error(item,
                           b"window still active: %s:%d\x00" as *const u8 as
    ...
    if window_pane_spawn(wp, (*args).argc, (*args).argv, path,
        ...
        screen_reinit(&mut (*wp).base as *mut screen);
        input_init(wp);
