...
pub const JOB_RUNNING: unnamed_26 = 0;
...
pub const LINE_SEL_RIGHT_LEFT: unnamed_20 = 2;
...
pub const LINE_SEL_NONE: unnamed_20 = 0;
...
pub const PROMPT_COMMAND: unnamed_2 = 1;
...
pub const PROMPT_ENTRY: unnamed_2 = 0;
#[derive ( Copy , Clone )]
#[repr ( C )]
pub struct winlinks {
...
pub const LINE_SEL_LEFT_RIGHT: unnamed_20 = 1;
#[derive ( Copy , Clone )]
#[repr ( C )]
...
pub const JOB_CLOSED: unnamed_26 = 2;
#[derive ( Copy , Clone )]
#[repr ( C )]
...
pub const JOB_DEAD: unnamed_26 = 1;
#[derive ( Copy , Clone )]
#[repr ( C )]
...
unsafe extern "C" fn cmd_resize_pane_exec(mut self_0: *mut cmd,
 ...
 -> cmd_retval {
    ...
    if 0 != args_has(args, 77 as u_char) {
        if cmd_mouse_window(&mut (*shared).mouse as *mut mouse_event,
                            &mut s as *mut *mut session) ==
            ...
            cmd_resize_pane_mouse_update(c,
                                         &mut (*shared).mouse as
                                             *mut mouse_event);
            return CMD_RETURN_NORMAL
        }
    } else if 0 != args_has(args, 90 as u_char) {
        ...
        if (*args).argc == 0i32 {
            adjust = 1i32 as u_int
        } else {
            adjust =
                strtonum(*(*args).argv.offset(0isize),
        ...
        if 0 != args_has((*self_0).args, 120 as u_char) {
            x =
                args_strtonum((*self_0).args, 120 as u_char,
                              2i32 as libc::c_longlong,
                              2147483647i32 as libc::c_longlong,
        ...
        if 0 != args_has((*self_0).args, 121 as u_char) {
            y =
                args_strtonum((*self_0).args, 121 as u_char,
                              2i32 as libc::c_longlong,
                              2147483647i32 as libc::c_longlong,
                              &mut cause as *mut *mut libc::c_char) as
                    libc::c_int;
        ...
        if 0 != args_has((*self_0).args, 76 as u_char) {
            layout_resize_pane(wp, LAYOUT_LEFTRIGHT,
                               adjust.wrapping_neg() as libc::c_int, 1i32);
        } else if 0 != args_has((*self_0).args, 82 as u_char) {
            ...
            layout_resize_pane(wp, LAYOUT_TOPBOTTOM,
                               adjust.wrapping_neg() as libc::c_int, 1i32);
        } else if 0 != args_has((*self_0).args, 68 as u_char) {
...
unsafe extern "C" fn cmd_resize_pane_mouse_update(mut c: *mut client,
 ...
 -> () {
    ...
    if wl == 0 as *mut libc::c_void as *mut winlink {
        ...
        ly = (*m).ly;
        lx = (*m).lx;
        if (*m).statusat == 0i32 && ly > 0i32 as libc::c_uint {
        ...
        while loop_0 != 0 as *mut libc::c_void as *mut window_pane {
            if !(0 == window_pane_visible(loop_0)) {
                sx = (*loop_0).xoff;
                if sx != 0i32 as libc::c_uint { sx = sx.wrapping_sub(1) }
                ex = (*loop_0).xoff.wrapping_add((*loop_0).sx);
                sy = (*loop_0).yoff;
                if sy != 0i32 as libc::c_uint { sy = sy.wrapping_sub(1) }
                ey = (*loop_0).yoff.wrapping_add((*loop_0).sy);
                if (lx == sx || lx == ex) && (ly >= sy && ly <= ey) &&
                       (wp_x == 0 as *mut libc::c_void as *mut window_pane ||
                            (*loop_0).sy > (*wp_x).sy) {
                    wp_x = loop_0
                }
                if (ly == sy || ly == ey) && (lx >= sx && lx <= ex) &&
                       (wp_y == 0 as *mut libc::c_void as *mut window_pane ||
                            (*loop_0).sx > (*wp_y).sx) {
                    wp_y = loop_0
                }
            }
        ...
        if wp_x == 0 as *mut libc::c_void as *mut window_pane &&
               wp_y == 0 as *mut libc::c_void as *mut window_pane {
            (*c).tty.mouse_drag_update = None;
            return
        } else {
            if wp_x != 0 as *mut libc::c_void as *mut window_pane {
                layout_resize_pane(wp_x, LAYOUT_LEFTRIGHT,
                                   x.wrapping_sub(lx) as libc::c_int, 0i32);
            }
            if wp_y != 0 as *mut libc::c_void as *mut window_pane {
                layout_resize_pane(wp_y, LAYOUT_TOPBOTTOM,
                                   y.wrapping_sub(ly) as libc::c_int, 0i32);
            }
            server_redraw_window((*wl).window);
            return;
        }
...
pub static mut cmd_resize_pane_entry: cmd_entry =
    unsafe {
        cmd_entry{name:
                      b"resize-pane\x00" as *const u8 as *const libc::c_char,
                  alias: b"resizep\x00" as *const u8 as *const libc::c_char,
                  args:
                      unnamed_24{template:
                                     b"DLMRt:Ux:y:Z\x00" as *const u8 as
                                         *const libc::c_char,
                                 lower: 0i32,
                                 upper: 1i32,},
                  usage:
                      b"[-DLMRUZ] [-x width] [-y height] [-t target-pane] [adjustment]\x00"
