...
extern "C" {
    ...
    #[no_mangle]
    fn strvisx(_: *mut libc::c_char, _: *const libc::c_char, _: size_t,
...
unsafe extern "C" fn cmd_save_buffer_exec(mut self_0: *mut cmd,
 ...
 -> cmd_retval {
    ...
    } else { path = *(*args).argv.offset(0isize) }
    if strcmp(path, b"-\x00" as *const u8 as *const libc::c_char) == 0i32 {
        if c == 0 as *mut libc::c_void as *mut client {
            ...
            return CMD_RETURN_ERROR
                      ...
                      0 != (*c).flags & 8192i32 {
            evbuffer_add((*c).stdout_data, bufdata as *const libc::c_void,
                         bufsize);
            server_client_push_stdout(c);
            return CMD_RETURN_NORMAL
        } else if bufsize > (2147483647i32 / 4i32 - 1i32) as libc::c_ulong {
            cmdq_error(item,
                       b"buffer too big\x00" as *const u8 as
                           *const libc::c_char);
            return CMD_RETURN_ERROR
        } else {
            ...
            while used != bufsize {
                start = bufdata.offset(used as isize);
                    ...
                    memchr(start as *const libc::c_void, 10,
                           bufsize.wrapping_sub(used)) as *const libc::c_char;
                if end != 0 as *mut libc::c_void as *const libc::c_char {
                    size =
                        start.offset_to(end).expect("bad offset_to") as
                            libc::c_long as size_t
                } else { size = bufsize.wrapping_sub(used) }
                msglen =
                    size.wrapping_mul(4i32 as
                                          libc::c_ulong).wrapping_add(1i32 as
                                                                          libc::c_ulong);
                msg =
                    xrealloc(msg as *mut libc::c_void, msglen) as
                        *mut libc::c_char;
                strvisx(msg, start, size, 1i32 | 8i32);
                cmdq_print(item,
                           b"%s\x00" as *const u8 as *const libc::c_char,
                           msg);
                used =
                    (used as
                         libc::c_ulong).wrapping_add(size.wrapping_add((end !=
                                                                            0
                                                                                as
                                                                                *mut libc::c_void
                                                                                as
        ...
        flags = b"wb\x00" as *const u8 as *const libc::c_char;
        if 0 != args_has((*self_0).args, 97 as u_char) {
            flags = b"ab\x00" as *const u8 as *const libc::c_char
        }
        ...
        if f == 0 as *mut libc::c_void as *mut FILE {
            ...
            return CMD_RETURN_ERROR
        } else if fwrite(bufdata as *const libc::c_void, 1i32 as size_t,
                         bufsize, f) != bufsize {
            cmdq_error(item,
                       b"%s: write error\x00" as *const u8 as
...
pub static mut cmd_show_buffer_entry: cmd_entry =
    unsafe {
        cmd_entry{name:
                      b"show-buffer\x00" as *const u8 as *const libc::c_char,
...
pub static mut cmd_save_buffer_entry: cmd_entry =
    unsafe {
        cmd_entry{name:
                      b"save-buffer\x00" as *const u8 as *const libc::c_char,
                  alias: b"saveb\x00" as *const u8 as *const libc::c_char,
                  args:
                      unnamed_19{template:
                                     b"ab:\x00" as *const u8 as
                                         *const libc::c_char,
                                 lower: 1i32,
                                 upper: 1i32,},
                  usage:
                      b"[-a] [-b buffer-name] path\x00" as *const u8 as
                          *const libc::c_char,
                  source:
                      cmd_entry_flag{flag: 0,
                                     type_0: CMD_FIND_PANE,
