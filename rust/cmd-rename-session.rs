 ...
 -> cmd_retval {
    ...
    if strcmp(newname, (*s).name) == 0i32 {
    ...
    } else if session_find(newname) != 0 as *mut libc::c_void as *mut session
     {
        ...
        notify_session(b"session-renamed\x00" as *const u8 as
                           *const libc::c_char, s);
        return CMD_RETURN_NORMAL
    };
}
        ...
        cmd_entry{name:
                  ...
                  args:
                      unnamed_8{template:
                                ...
                                upper: 1i32,},
                  usage:
                      b"[-t target-session] new-name\x00" as *const u8 as
                          *const libc::c_char,
                  source:
