...
pub const _ISblank: unnamed_38 = 1;
...
pub const JOB_RUNNING: unnamed_3 = 0;
#[derive ( Copy , Clone )]
#[repr ( C )]
pub union unnamed_8 {
...
pub const JOB_CLOSED: unnamed_3 = 2;
pub const JOB_DEAD: unnamed_3 = 1;
pub const _IScntrl: unnamed_38 = 2;
#[derive ( Copy , Clone )]
#[repr ( C )]
pub struct args {
    pub tree: args_tree,
...
pub const _ISgraph: unnamed_38 = 32768;
...
pub const _ISupper: unnamed_38 = 256;
#[derive ( Copy , Clone )]
#[repr ( C )]
...
pub const _ISdigit: unnamed_38 = 2048;
#[derive ( Copy , Clone )]
#[repr ( C )]
...
pub const _ISpunct: unnamed_38 = 4;
#[derive ( Copy , Clone )]
#[repr ( C )]
...
pub const _ISalpha: unnamed_38 = 1024;
pub const _ISlower: unnamed_38 = 512;
#[derive ( Copy , Clone )]
#[repr ( C )]
...
pub const _ISalnum: unnamed_38 = 8;
...
pub const _ISxdigit: unnamed_38 = 4096;
#[derive ( Copy , Clone )]
#[repr ( C )]
pub struct window {
    pub id: u_int,
...
pub const _ISspace: unnamed_38 = 8192;
...
pub const _ISprint: unnamed_38 = 16384;
#[derive ( Copy , Clone )]
#[repr ( C )]
 ...
 -> *mut options_entry {
    ...
    if (*elm).entry.rbe_left == 0 as *mut libc::c_void as *mut options_entry {
        ...
        if !parent.is_null() {
            ...
            current_block = 3542848905993250953;
        } else { current_block = 3542848905993250953; }
    }
    match current_block {
        9386390421034826751 => {
            parent = (*elm).entry.rbe_parent;
...
#[no_mangle]
pub unsafe extern "C" fn options_add(mut oo: *mut options,
 ...
 -> *mut options_entry {
    let mut o: options_entry =
        options_entry{owner: 0 as *mut options,
                      ...
                      unnamed: unnamed_31{string: 0 as *mut libc::c_char,},
                      entry:
                          unnamed_23{rbe_left: 0 as *mut options_entry,
...
#[no_mangle]
pub unsafe extern "C" fn options_parent_table_entry(mut oo: *mut options,
                                                    mut s:
                                                        *const libc::c_char)
 -> *const options_table_entry {
    let mut o: *mut options_entry = 0 as *mut options_entry;
