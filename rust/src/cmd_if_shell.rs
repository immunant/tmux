...
#[repr ( C )]
pub struct event {
    pub ev_active_next: unnamed_21,
    pub ev_next: unnamed_6,
...
pub union unnamed_36 {
    ev_next_with_common_timeout: unnamed_9,
...
unsafe extern "C" fn cmd_if_shell_callback(mut job: *mut job) -> () {
    ...
    if (0 !=
            !(unnamed_30{__in: (*job).status,}.__i & 127i32 == 0i32) as
                libc::c_int ||
            (unnamed_11{__in: (*job).status,}.__i & 65280i32) >> 8i32 != 0i32)
       {
        cmd = (*cdata).cmd_else
