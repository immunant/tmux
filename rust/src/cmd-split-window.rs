...
extern "C" {
    ...
    fn window_set_active_pane(_: *mut window, _: *mut window_pane)
     -> libc::c_int;
    #[no_mangle]
    fn window_add_pane(_: *mut window, _: *mut window_pane, _: libc::c_int,
                       _: libc::c_int, _: u_int) -> *mut window_pane;
    #[no_mangle]
    fn window_remove_pane(_: *mut window, _: *mut window_pane) -> ();
    #[no_mangle]
    fn window_pane_spawn(_: *mut window_pane, _: libc::c_int,
                         _: *mut *mut libc::c_char, _: *const libc::c_char,
                         _: *const libc::c_char, _: *const libc::c_char,
                         _: *mut environ, _: *mut termios,
    ...
    fn layout_split_pane(_: *mut window_pane, _: layout_type, _: libc::c_int,
                         _: libc::c_int, _: libc::c_int) -> *mut layout_cell;
    #[no_mangle]
...
pub const JOB_DEAD: unnamed_14 = 1;
#[derive ( Copy , Clone )]
#[repr ( C )]
pub struct job {
    pub state: unnamed_14,
    pub flags: libc::c_int,
...
pub const JOB_CLOSED: unnamed_14 = 2;
#[derive ( Copy , Clone )]
#[repr ( C )]
...
pub const JOB_RUNNING: unnamed_14 = 0;
...
unsafe extern "C" fn cmd_split_window_exec(mut self_0: *mut cmd,
 ...
 -> cmd_retval {
    ...
    if 0 != args_has(args, 104 as u_char) { type_0 = LAYOUT_LEFTRIGHT }
    before = args_has(args, 98 as u_char);
    size = 1i32.wrapping_neg();
    if 0 != args_has(args, 108 as u_char) {
        size =
            args_strtonum(args, 108 as u_char, 0i32 as libc::c_longlong,
                          2147483647i32 as libc::c_longlong,
                          &mut cause as *mut *mut libc::c_char) as
                libc::c_int;
        if cause != 0 as *mut libc::c_void as *mut libc::c_char {
            xasprintf(&mut new_cause as *mut *mut libc::c_char,
                      b"size %s\x00" as *const u8 as *const libc::c_char,
                      cause);
            free(cause as *mut libc::c_void);
            cause = new_cause;
            current_block = 16692691265096570279;
        } else { current_block = 13536709405535804910; }
    } else if 0 != args_has(args, 112 as u_char) {
        percentage =
            args_strtonum(args, 112 as u_char, 0i32 as libc::c_longlong,
                          2147483647i32 as libc::c_longlong,
                          &mut cause as *mut *mut libc::c_char) as
                libc::c_int;
        if cause != 0 as *mut libc::c_void as *mut libc::c_char {
    ...
    match current_block {
        13536709405535804910 => {
            ...
            lc =
                layout_split_pane(wp, type_0, size, before,
                                  args_has(args, 102 as u_char));
            if lc == 0 as *mut libc::c_void as *mut layout_cell {
                cause =
                    xstrdup(b"pane too small\x00" as *const u8 as
                                *const libc::c_char)
            } else {
                new_wp =
                    window_add_pane(w, wp, before,
                                    args_has(args, 102 as u_char), hlimit);
                ...
                if window_pane_spawn(new_wp, argc, argv, path, shell, cwd,
                                     env, (*s).tio,
                    ...
                    notify_window(b"window-layout-changed\x00" as *const u8 as
                                      *const libc::c_char, w);
                    cmd_find_from_winlink_pane(&mut fs as *mut cmd_find_state,
                                               wl, new_wp, 0i32);
                    hooks_insert((*s).hooks, item,
    ...
    if new_wp != 0 as *mut libc::c_void as *mut window_pane {
...
pub static mut cmd_split_window_entry: cmd_entry =
    unsafe {
        cmd_entry{name:
                      b"split-window\x00" as *const u8 as *const libc::c_char,
                  alias: b"splitw\x00" as *const u8 as *const libc::c_char,
                  args:
                      unnamed_11{template:
