...
pub struct paste_buffer {
    ...
    pub order: u_int,
    pub name_entry: unnamed_20,
    pub time_entry: unnamed_23,
}
#[derive ( Copy , Clone )]
#[repr ( C )]
        ...
        paste_buffer{data: 0 as *mut libc::c_char,
                     ...
                     name_entry:
                         unnamed_20{rbe_left: 0 as *mut paste_buffer,
                                    ...
                                    rbe_color: 0,},
                     time_entry:
                         unnamed_23{rbe_left: 0 as *mut paste_buffer,
                                    rbe_right: 0 as *mut paste_buffer,
                                    rbe_parent: 0 as *mut paste_buffer,
                                    rbe_color: 0,},};
 ...
 -> *mut paste_buffer {
    ...
    if (*elm).time_entry.rbe_left ==
        ...
        if !parent.is_null() {
            ...
            current_block = 5508137219998193664;
        } else { current_block = 5508137219998193664; }
    }
    match current_block {
        9386390421034826751 => {
            parent = (*elm).time_entry.rbe_parent;
 ...
 -> *mut paste_buffer {
    ...
    if (*elm).name_entry.rbe_left ==
        ...
        if !parent.is_null() {
            ...
            current_block = 1494486222542458720;
        } else { current_block = 1494486222542458720; }
    }
    match current_block {
        9386390421034826751 => {
            parent = (*elm).name_entry.rbe_parent;
