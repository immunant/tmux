...
pub const _ISalnum: unnamed_33 = 8;
...
pub const _IScntrl: unnamed_33 = 2;
#[derive ( Copy , Clone )]
#[repr ( C )]
...
pub const _ISupper: unnamed_33 = 256;
#[derive ( Copy , Clone )]
#[repr ( C )]
...
pub const _ISdigit: unnamed_33 = 2048;
#[derive ( Copy , Clone )]
#[repr ( C )]
pub struct cmd {
...
pub const _ISprint: unnamed_33 = 16384;
...
pub const _ISalpha: unnamed_33 = 1024;
...
pub const _ISxdigit: unnamed_33 = 4096;
#[derive ( Copy , Clone )]
#[repr ( C )]
...
pub const _ISgraph: unnamed_33 = 32768;
#[derive ( Copy , Clone )]
#[repr ( C )]
...
pub const _ISlower: unnamed_33 = 512;
...
pub const _ISblank: unnamed_33 = 1;
#[derive ( Copy , Clone )]
#[repr ( C )]
pub struct sessions {
...
pub const _ISpunct: unnamed_33 = 4;
#[derive ( Copy , Clone )]
#[repr ( C )]
...
pub const _ISspace: unnamed_33 = 8192;
#[derive ( Copy , Clone )]
#[repr ( C )]
        ...
        if tmplen >
            ...
            match (*lc).type_0 as libc::c_uint {
                0 => {
                    ...
                    current_block = 1996969897162909940;
                }
                1 => { current_block = 1996969897162909940; }
        ...
        if csum as libc::c_int != layout_checksum(layout) as libc::c_int {
            ...
            if lc == 0 as *mut libc::c_void as *mut layout_cell {
                ...
                if *layout as libc::c_int != 0 {
                    current_block = 16118680137268336797;
                } else { current_block = 820271813250567934; }
                loop  {
                    match current_block {
                        16118680137268336797 => {
                            layout_free_cell(lc);
                            return 1i32.wrapping_neg()
                        }
                        _ => {
                ...
                if **layout as libc::c_int != 44 {
                    ...
                    *layout = (*layout).offset(1isize);
                    ...
                    match **layout as libc::c_int {
                        ...
                        _ => { current_block = 10348618961924371767; }
                    }
                    loop  {
                        match current_block {
                            10348618961924371767 => {
                                layout_free_cell(lc);
                                return 0 as *mut layout_cell
                            }
                            _ => {
                                *layout = (*layout).offset(1isize);
                                ...
                                if lcchild ==
                                       0 as *mut libc::c_void as
                                           *mut layout_cell {
                                    current_block = 10348618961924371767;
                                    continue ;
                                }
                                loop  {
