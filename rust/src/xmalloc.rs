...
pub unsafe extern "C" fn xcalloc(mut nmemb: size_t, mut size: size_t)
 -> *mut libc::c_void {
    let mut ptr: *mut libc::c_void = 0 as *mut libc::c_void;
    if size == 0i32 as libc::c_ulong || nmemb == 0i32 as libc::c_ulong {
        fatalx(b"xcalloc: zero size\x00" as *const u8 as *const libc::c_char);
    } else {
        ptr = calloc(nmemb, size);
        if ptr == 0 as *mut libc::c_void {
            fatalx(b"xcalloc: allocating %zu * %zu bytes: %s\x00" as *const u8
                       as *const libc::c_char, nmemb, size,
                   strerror(*__errno_location()));
        } else { return ptr }
    };
}
...
pub unsafe extern "C" fn xrealloc(mut ptr: *mut libc::c_void,
    ...
    return xreallocarray(ptr, 1i32 as size_t, size);
}
#[no_mangle]
pub unsafe extern "C" fn xreallocarray(mut ptr: *mut libc::c_void,
 ...
 -> *mut libc::c_void {
    ...
    if nmemb == 0i32 as libc::c_ulong || size == 0i32 as libc::c_ulong {
        fatalx(b"xreallocarray: zero size\x00" as *const u8 as
                   *const libc::c_char);
    } else {
        new_ptr = reallocarray(ptr, nmemb, size);
        if new_ptr == 0 as *mut libc::c_void {
...
pub unsafe extern "C" fn xvasprintf(mut ret: *mut *mut libc::c_char,
 ...
 -> libc::c_int {
    ...
    if i < 0i32 || *ret == 0 as *mut libc::c_void as *mut libc::c_char {
...
pub unsafe extern "C" fn xvsnprintf(mut str: *mut libc::c_char,
 ...
 -> libc::c_int {
    let mut i: libc::c_int = 0;
    if len > 2147483647i32 as libc::c_ulong {
