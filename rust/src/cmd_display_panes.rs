 ...
 -> cmd_retval {
    ...
    if c == 0 as *mut libc::c_void as *mut client {
                                                                  ...
                                                                  *mut libc::c_void)
     {
        ...
        (*c).identify_callback = Some(cmd_display_panes_callback);
        if (*args).argc != 0i32 {
            (*c).identify_callback_data =
                xstrdup(*(*args).argv.offset(0isize)) as *mut libc::c_void
        } else {
            (*c).identify_callback_data =
        ...
        if 0 != args_has(args, 100 as u_char) {
            delay =
                args_strtonum(args, 100 as u_char, 0i32 as libc::c_longlong,
                              (2147483647i32 as
...
unsafe extern "C" fn cmd_display_panes_callback(mut c: *mut client,
 ...
 -> () {
    ...
    if !(wp == 0 as *mut libc::c_void as *mut window_pane) {
        ...
        cmd = cmd_template_replace(template, expanded, 1i32);
        cmdlist =
        ...
        if cmdlist == 0 as *mut libc::c_void as *mut cmd_list {
            if cause != 0 as *mut libc::c_void as *mut libc::c_char {
                new_item =
                    cmdq_get_callback1(b"cmd_display_panes_error\x00" as
                                           *const u8 as *const libc::c_char,
                                       Some(cmd_display_panes_error),
...
unsafe extern "C" fn cmd_display_panes_error(mut item: *mut cmdq_item,
...
pub static mut cmd_display_panes_entry: cmd_entry =
    unsafe {
        cmd_entry{name:
                  ...
                  args:
                      unnamed_29{template:
                                     b"d:t:\x00" as *const u8 as
                                         *const libc::c_char,
                                 lower: 0i32,
                                 upper: 1i32,},
                  usage:
                      b"[-d duration] [-t target-client]\x00" as *const u8 as
                          *const libc::c_char,
                  source:
