 ...
 -> *mut key_binding {
    ...
    if (*elm).entry.rbe_left == 0 as *mut libc::c_void as *mut key_binding {
        ...
        if !parent.is_null() {
            ...
            current_block = 14250698216832642938;
        } else { current_block = 14250698216832642938; }
    }
    match current_block {
        9386390421034826751 => {
            parent = (*elm).entry.rbe_parent;
 ...
 -> *mut key_table {
    ...
    if (*elm).entry.rbe_left == 0 as *mut libc::c_void as *mut key_table {
        ...
        if !parent.is_null() {
            ...
            current_block = 2272319959924446093;
        } else { current_block = 2272319959924446093; }
    }
    match current_block {
        9386390421034826751 => {
            parent = (*elm).entry.rbe_parent;
...
pub static mut key_tables: key_tables =
    unsafe { key_tables{rbh_root: 0 as *const key_table as *mut key_table,} };
#[no_mangle]
 ...
 -> *mut key_table {
    let mut table_find: key_table =
        key_table{name: 0 as *const libc::c_char,
                  ...
                  references: 0,
                  entry:
                      unnamed_28{rbe_left: 0 as *mut key_table,
...
pub unsafe extern "C" fn key_bindings_add(mut name: *const libc::c_char,
    ...
    let mut bd_find: key_binding =
        key_binding{key: 0,
                    ...
                    flags: 0,
                    entry:
                        unnamed_38{rbe_left: 0 as *mut key_binding,
...
pub unsafe extern "C" fn key_bindings_dispatch(mut bd: *mut key_binding,
 ...
 -> () {
    ...
    readonly = 1i32;
    cmd = (*(&mut (*(*bd).cmdlist).list as *mut unnamed_5)).tqh_first;
